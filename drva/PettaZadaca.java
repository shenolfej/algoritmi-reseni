...
public class PettaZadaca {
    public static void main(String[] args){
        ...
        for(int i = 0; i<n; i++){
            ...
            if(flag){
                ...
                System.out.println(sumDegree(findNode(tree.root, input[1])));
            }
        }
    }
    ...
    public static int sumDegree(BNode<String> curr){
        if(curr.left == null && curr.right == null) return 0;
        int total = 0;
        if(curr.left != null) total += 1 + sumDegree(curr.left);
        if(curr.right != null) total += 1 + sumDegree(curr.right);
        return total;
    }
