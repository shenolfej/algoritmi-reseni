...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i = 0; i<m ;i++){
            String[] input = scan.nextLine().split(" ");
            graph.removeEdge(input[0],input[1]);
        };
        ...
        for (String place : places) {
            if (!visited.contains(place)) {
                exploreComponent(graph, place, visited);
                totalComponents++;
            }
        }
    ...
    public static void exploreComponent(AdjacencyListGraph<String> graph, String start, Set<String> visited) {
